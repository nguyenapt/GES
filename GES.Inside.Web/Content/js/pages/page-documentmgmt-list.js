$(function () {
    var postUrl = "/documentmgmt/GetDataForGesDocumentJqGrid";
    var gridCaption = "";
    var deleteDocumentUrl = "/documentmgmt/DeleteDocuments";

    var grid = $("#tblgesdocuments");
    ...
    grid.jqGrid({
        ...
        datatype: "json",
        mtype: "post",
        colNames: ["Id", "Name", "Service", "Comment", "Created"],
        colModel: [
        ...
        ondblClickRow: function (rowid, iRow, iCol, e) {
            ...
            $.ajax({
                ...
                type: "POST",
                url: "/documentmgmt/CreateForm_Document",
                data: JSON.stringify({ documentId: rowData.Id })
            })
            .done(function (response, textStatus, jqXHR) {
                $("#newGesDocumentModalDialog").html(response);

                var dialogContainerId = "newGesDocumentModalDialog";
...
function OpenDialog(dialogContainerId) {
    ...
    $("#newGesDocumentModalDialog .modal").modal("show");

    var $form = $("#newGesDocumentModalDialog").find("form");
    ...
    $form.on("submit", function (event) {
        ...
        $.ajax({
            url: '/documentmgmt/CreateUpdateGesDocument',
