...
{
    public interface II_GesSourceDialogueService : IEntityService<I_GesSourceDialogues>
    {
        I_GesSourceDialogues GetById(long id);

        IEnumerable<I_GesSourceDialogues> GetSourceDialogues(long gesCaseReportsId);
    }
}
