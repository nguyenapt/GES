...
{
    /// <summary>
    /// The core GES logging API, used for writing log events.
    /// </summary>
    /// <example>
    ...
    /// </example>
    /// <remarks>
    /// The methods on <see cref="IGesLogger"/> (and its static sibling) are guaranteed
    /// never to throw exceptions. Methods on all other types may.
    /// </remarks>
    public interface IGesLogger
    {
        /// <summary>
